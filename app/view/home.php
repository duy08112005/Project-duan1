                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="header__top__right">
                            <?php 
                               ...
                               <span style="color: aliceblue; margin-right: 30px;">Chào,<?=$_SESSION['username']?>!</span>
                               
                                <a href="./admin/index.php">Trang quản trị</a>
                                <a href="#" style="margin-right: 20px;">Chỉnh sửa thông tin</a>
                                <a href="#">Giỏ Hàng</a>
                                <a href="?act=log-out">Đăng Xuất</a>
                                </div>
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="../view/shopping-cart.html">Shopping Cart</a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <a href="./view/shopping-cart.php" class="add-cart">+ Add To Cart</a>
                                    <div class="rating">
